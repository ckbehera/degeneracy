...
% Given the magnitude of a drugeffect on a model, the program calculates the 
% maximum percentage of deviations of the activity profiles of
% particular model from those of the experimental outcomes
...
[wi1,wi2,wi3,wi4,w5e1,w5e2,w5edi,w5i1,w5i2,Jd_5ht3,Jg_5ht3,Jd5e,J55e,Jd5i,J55i,Jdi,Jd5,J5d,J5di,w5ii,w5ee,wii, wdd,w55]=connectdstbl2(modelno, rew); 
...
%calculate maximum of % of differences
dopa=mean(rdam)                  % 15% variation allowed 
sero=mean(r5ht)                  % 15% variation allowed
drngaba=mean(rdgaba)             % 15% variation allowed
vtagaba=mean(rvgaba)             % 15% variation allowed
glu=mean(rglu)                   % 15% variation allowed
