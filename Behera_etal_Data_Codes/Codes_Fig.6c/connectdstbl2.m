...
function [wi1,wi2,wi3,wi4,w5e1,w5e2,w5edi,w5i1,w5i2,Jd_5ht3,Jg_5ht3,Jd5e,J55e,Jd5i,J55i,Jdi,Jd5,J5d,J5di,J5ii,J5ee,Jii, wdd,w55] = connectdstbl2(modelno, rew)
%% play with the w's and j's in this section
X=input('enter drug effect value ');
switch lower(modelno)
            ...
            if SeroDA==0
               % SeroGlu = input('for excitatory 5HT-Glu connection enter 1 else 0 ');
                if SeroGlu==0
                    ...
                    wi2=2*X;      % Connection weight from DA in VTA to GABA pop in VTA 
                    wi3=1;      % Connection weight from 5-HT in DRN to DA pop in VTA 
                    wi4=10*X;     %Connection weight from DA pop in VTA to 5-HT in DRN 
                    ...
                    w5i2=10*X;     % Connection weight from DA in VTA to GABA in DRN, relative to DA-to-5-HT 
                    ...
                    J5ii=0.5;   % Self-inhibition of GABAergic population in DRN 
                    J5ee=0.5;   % Self-excitation of Glutamergic population in DRN 
                    Jii=10;     % Self-inhibition of GABAergic population in VTA 
                    wdd=1*X;      % Self-inhibition of DA population in VTA 
    ...
    case 'k'
        ...
        wi1=20;     % Connection weight from 5-HT in DRN to GABA pop in VTA 
        wi2=0*X;      % Connection weight from DA in VTA to GABA pop in VTA 
        wi3=0;      % Connection weight from 5-HT in DRN to DA pop in VTA 
        wi4=0*X;      %Connection weight from DA pop in VTA to 5-HT in DRN 
        % ============= Non-principal glutamatergic neurons in DRN =========
        ...
        w5i2=0*X;     % Connection weight from DA in VTA to GABA in DRN, relative to DA-to-5-HT
    ...
    case 'g'
        ...
        w5i1=10;    % Connection weight from 5-HT to GABA pop in DRN, relative to 5-HT-to-DA 
        w5i2=20*X;     % Connection weight from DA in VTA to GABA in DRN, relative to DA-to-5-HT 
        ...
        if rew==0
            ...
            if SeroDA==0
                ...
                if SeroGlu==0
                    ...
                    wi2=2*X;      % Connection weight from DA in VTA to GABA pop in VTA 
                    wi3=-1;      % Connection weight from 5-HT in DRN to DA pop in VTA 
                    wi4=20*X;     %Connection weight from DA pop in VTA to 5-HT in DRN 
                    % ============= Non-principal glutamatergic neurons in DRN =========
            ...
            if SeroDA==0
                ...
                if SeroGlu==0
                    ...
                    wi2=2*X;      % Connection weight from DA in VTA to GABA pop in VTA 
                    wi3=1;      % Connection weight from 5-HT in DRN to DA pop in VTA 
                    wi4=30*X;     %Connection weight from DA pop in VTA to 5-HT in DRN 
                    % ============= Non-principal glutamatergic neurons in DRN =========
