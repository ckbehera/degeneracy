...
[wi1,wi2,wi3,wi4,w5e1,w5e2,w5edi,w5i1,w5i2,Jd_5ht3,Jg_5ht3,Jd5e,J55e,Jd5i,J55i,Jdi,Jd5,J5d,J5di,J5ii,J5ee,Jii, wdd,w55]=connectdv3modelsf2(modelno, rew); 
...
%   %%
    ...
    if modelno=='l'
        ...
        Ii(k)  =  wi1*Id5(k) + Jg_5ht3*r5(k) - Jii*Fi(k) + I_appi(k)-J5d*F5i(k) ;                       % FOR MORALES NEW PAPER; Overall (weighted) input to local GABAergic population in VTA
