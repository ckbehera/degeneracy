%finds the J matrix and eigen values
load variables.mat
% x(1) is [5HT]
% x(2) is [DA]
a=exp(4);
...
if modelno=='l'
    ...
    Con=[1-g_5e*J5ee g_5e*w5edi 0;J55e*g_di*Jg_5ht3 1+Jii+J5di*g_di*g_5*Jg_5ht3 J5d+J55i*g_di*g_di*g_5*Jg_5ht3;0 g_5i*Jd5 1+g_5i*J5ii];
    itype=5;
else
    J=[J55e -J5di -J55i;Jd5e -Jdi -Jd5i];
    Con=[1-g_5e*J5ee g_5e*w5edi 0;0 1+g_di*Jii g_di*J5d;0 g_5i*Jd5 1+g_5i*J5ii];
    itype=4;
end
A = (gain*J*inv(Con))';
...
for it = 1:size(Iap,2)
    ...
    c = [A(:)', g_5, a, wi4, g_5e, w5e2, g_di, wi3, g_5i, w5i2, w5e1, w5i1,...
        g_d, wi2, Iap(1,it), Iap(3,it), Iap(4,it), Iap(2,it), I_app,Jii,J55e,J55i,Jd5e,...
